namespace RecipeWinForms
{
    partial class frmCookbookList
    {
        ...
        private void InitializeComponent()
        {
            ...
            tblMain.RowCount = 2;
            tblMain.RowStyles.Add(new RowStyle(SizeType.Percent, 16.8253975F));
            tblMain.RowStyles.Add(new RowStyle(SizeType.Percent, 83.17461F));
            ...
            tblMain.SetColumnSpan(gCookbookList, 2);
            gCookbookList.Dock = DockStyle.Fill;
            gCookbookList.Location = new Point(3, 109);
            gCookbookList.Name = "gCookbookList";
            gCookbookList.RowHeadersWidth = 51;
            gCookbookList.Size = new Size(1094, 518);
            gCookbookList.TabIndex = 0;
            // 
            // btnNewCookbook
            // 
            btnNewCookbook.AutoSize = true;
            btnNewCookbook.Location = new Point(3, 40);
            btnNewCookbook.Margin = new Padding(3, 40, 3, 25);
