...
begin
	...
	select r.RecipeId, r.CuisineId, r.UserStaffId, r.RecipeName, r.Calorie, r.DateDrafted, r.DatePublished, r.DateArchived, r.RecipeStatus, r.RecipePictureCode, UserName = concat(us.UserFirstName, ' ', us.UserLastName), NumIngredients = isnull(x.NumIngredients, 0)
	from Recipe r
	left join x
